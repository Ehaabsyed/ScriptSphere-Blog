...
function Blogs() {
  ...
  const handleLike = async (e, id) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/auth/bloglike", { username, id }, { withCredentials: true });
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/auth/getblogs")
      .then(response => {
    ...
    axios.get("http://localhost:5000/auth/top-liked")
      .then(response => {
